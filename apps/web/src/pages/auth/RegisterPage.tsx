...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl opacity-50"></div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="glass-card rounded-2xl shadow-2xl p-8 border border-slate-700/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2">Comienza tu viaje hoy</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="glass-input w-full px-4 py-3 rounded-lg text-slate-100 focus:outline-none transition cursor-pointer"
              >
                <option value="passenger" className="bg-slate-900">Pasajero</option>
                <option value="driver" className="bg-slate-900">Conductor</option>
              </select>
            </div>
